...
1. **Clone the repository**
   ```bash
   git clone https://github.com/SushantPatil-Tech/portfolio.git
   cd portfolio
   ```
...
### Colors
The portfolio uses a dark theme with indigo/purple accents. To customize colors, modify the Tailwind config or CSS variables in `src/App.css`.
...
- `src/components/Experience.jsx` - Experience & Education
- `src/components/Projects.jsx` - Projects showcase
- `src/components/Contact.jsx` - Contact information

### Animations
Customize animations in `src/App.css` or use Framer Motion for more complex animations.
